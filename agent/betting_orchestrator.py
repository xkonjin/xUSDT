...
class BettingOrchestrator:
    ...
    def __init__(
        ...
        self.liquidity_buffer_service = liquidity_buffer_service or LiquidityBufferService()
    ...
    def place_bet_from_balance(
        ...
        try:
            ...
            size = str(bet_amount_usdc / 1_000_000)  # Convert from atomic units to tokens
            ...
            polymarket_order_id = order_response.get("order_id") or order_response.get("id")
            ...
            # Refund balance and buffer on failure
            try:
                self.balance_service.add_balance(user_address, bet_amount_usdc)
            except:
                pass
    ...
    def check_order_status(self, prediction_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if prediction.polymarket_order_id:
                try:
                    order_status = self.polymarket_client.get_order(prediction.polymarket_order_id)
                except Exception as e:
