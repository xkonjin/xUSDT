      ...
      <div className="rounded-2xl bg-white p-6 shadow-xl">
        <div className="text-center">
          ...
          <p className="mb-4 text-gray-600">
            ZKP2P on-ramp requires the Peer browser extension, which is only
    ...
    return (
      <div className="rounded-2xl bg-white p-6 shadow-xl">
        <div className="text-center">
          ...
          <p className="mb-4 text-gray-600">
            To add funds with Venmo, Revolut, or other payment apps, you need to
            install the Peer browser extension.
          </p>
          <button
              ...
              {index < 2 && (
                <div
                  className={`mx-2 h-0.5 flex-1 ${
                    isActive ? "bg-plenmo-500" : "bg-gray-200"
                  }`}
                />
              )}
            </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border-2 border-gray-200 py-4 pl-12 pr-20 text-2xl font-bold text-gray-900 focus:border-plenmo-500 focus:outline-none"
                    placeholder="0.00"
                    min="1"
                    step="0.01"
                  />
                ...
                {["25", "50", "100", "250"].map((quickAmount) => (
                  <button
                    ...
                    className={`flex-1 rounded-lg border-2 py-2 text-sm font-medium transition ${
                      amount === quickAmount
                        ? "border-plenmo-500 bg-plenmo-50 text-plenmo-700"
              ...
              <div className="space-y-3">
                {PAYMENT_OPTIONS.filter((p) =>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="flex w-full items-center gap-4 rounded-xl border-2 border-gray-200 p-4 transition hover:border-plenmo-300 hover:bg-plenmo-50 disabled:opacity-50"
                  >
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r ${payment.color}`}
                    >
          ...
          {step === "processing" && (
            ...
            >
              <div className="mx-auto mb-6 h-16 w-16">
                <svg
                  className="animate-spin h-16 w-16 text-plenmo-500"
                  fill="none"
                  viewBox="0 0 24 24"
                >
                  <circle
