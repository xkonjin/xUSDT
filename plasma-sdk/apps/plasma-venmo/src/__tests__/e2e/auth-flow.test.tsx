...
function AuthTestComponent() {
  ...
  return (
    <div data-testid="authenticated">
      ...
      <p data-testid="wallet-address">{wallets[0]?.address || "No wallet"}</p>
...
describe("Auth Flow E2E Tests", () => {
  ...
  describe("Login Flow", () => {
    ...
    it("should display user email after successful login", async () => {
      const mockUser = createMockUser({
        email: { address: TEST_EMAILS.VALID },
      });
      const mockWallet = createMockWallet();
  ...
  describe("Wallet Creation", () => {
    ...
    it("should handle multiple wallets (use first)", () => {
      ...
      const wallet2 = createMockWallet({
        address: TEST_ADDRESSES.RECIPIENT_ADDRESS,
      });
