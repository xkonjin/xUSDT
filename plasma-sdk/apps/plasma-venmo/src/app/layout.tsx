 ...
 *
 * Plenmo - Pay anyone instantly
 * Brand: #1DB954 green, premium fintech aesthetic
...
export const metadata = {
  ...
  description:
    "Send and receive money instantly with zero fees. Simple, secure, and lightning fast payments powered by Plasma.",
  keywords: [
    "payments",
    "money transfer",
    "send money",
