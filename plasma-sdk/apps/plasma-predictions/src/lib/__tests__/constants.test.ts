/**
 * Unit its for constants.ts utility functions
 */
...
describe("formatUSDT", () => {
  it("formats BigInt to USD string", () => {
...
describe("parseUSDT", () => {
  it("parses number to atomic units", () => {
