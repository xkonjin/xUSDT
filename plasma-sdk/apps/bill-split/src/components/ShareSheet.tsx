...
export function ShareSheet({
  ...
  function shareSMS(link: ShareLink) {
    const message = encodeURIComponent(
      `You owe $${link.amount.toFixed(2)} for "${billTitle}". Pay here: ${
        link.url
      }`
    );
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: `${link.participantName}, you owe $${link.amount.toFixed(
            2
          )} for "${billTitle}"`,
          url: link.url,
        });
    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 animate-slide-up">
        <div className="max-w-lg mx-auto">
          <div className="bg-[rgb(20,20,25)] rounded-t-[32px] shadow-clay-lg overflow-hidden">
            {/* Handle */}
            ...
            <div className="px-6 pb-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-white/50 text-sm mt-0.5">{billTitle}</p>
              </div>
              <button
                onClick={onClose}
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold text-splitzy-400 font-heading">
                  ...
                  {/* Link preview */}
                  <div className="bg-white/5 rounded-xl px-3 py-2 text-xs text-white/40 font-mono truncate">
                    {link.url}
                  </div>
                </div>
              ))}
      ...
      {showQrModal && qrCodeUrl && qrParticipant && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[60] p-4">
            <div className="bg-[rgb(28,28,36)] rounded-3xl p-6 max-w-sm w-full animate-fade-in-scale">
