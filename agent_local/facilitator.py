...
_mod = importlib.import_module('agent.facilitator')

# Ensure agent.facilitator is accessible as an attribute
sys.modules['agent'].facilitator = _mod  # type: ignore[attr-defined]
